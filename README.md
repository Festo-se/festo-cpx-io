...
Documentation can be found [here](https://festo-se.github.io/festo-cpx-io/) and in the [examples](./examples) directory.
...
```
pip install festo-cpx-io --group dev
```

### From git repo

You can also install directly from the git repo. It is recommended to use astrals `uv`.
...
3. Setup all dependencies and install
...
### [CLI](https://festo-se.github.io/festo-cpx-io/features/cli.html) - [`cli`](https://festo-se.github.io/festo-cpx-io/cpx_io.cli.html#module-cpx_io.cli.cli)
...
- [`cpx-e`](https://festo-se.github.io/festo-cpx-io/features/cli.html#cpx-e) is a subcommand to execute commands on CPX-E devices
...
- [`cpx-ap`](https://festo-se.github.io/festo-cpx-io/features/cli.html#cpx-ap) is a subcommand to execute commands on CPX-AP devices
...
options:
  ...
  -mt, --modbus-timeout Set a modbus timeout in seconds. Minimum timeout is 0.1s (100 ms).
                        Exception: setting timeout to 0.0s means an infinite timeout (no timeout).
                        If you don't specify a timeout we set it internally to None and the default
                        timeout on the device itself remains active!
action commands:
  Action to perform
...
### [CPX-SYSTEM](https://festo-se.github.io/festo-cpx-io/features/cpx_io.html) - [`cpx_system`](https://festo-se.github.io/festo-cpx-io/cpx_io.cpx_system.html#)

#### [CPX-E](https://festo-se.github.io/festo-cpx-io/cpx_io.cpx_system.cpx_e.html)
...
For more information on how to setup the system and how to adress the modules read the [docs](https://festo-se.github.io/festo-cpx-io/features/cpx_io.html#cpx-e) see the [examples](https://festo-se.github.io/festo-cpx-io/examples.html#cpx-e).

#### [CPX-AP](https://festo-se.github.io/festo-cpx-io/cpx_io.cpx_system.cpx_ap.html)
...
For more information on how to setup the system and how to adress the modules, read the [docs](https://festo-se.github.io/festo-cpx-io/features/cpx_io.html#cpx-ap) see the [examples](https://festo-se.github.io/festo-cpx-io/examples.html#cpx-ap).
