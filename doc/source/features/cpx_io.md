...
The modules offer different functions, but most of them have `read_channel()` and depending on the kind of module, `write_channel()`, as well as very individual configure functions. Read the [doc](https://festo-se.github.io/festo-cpx-io/) and have a look at the [examples](../examples) for more information.
