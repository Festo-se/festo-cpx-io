...
class CpxE1Ci(CpxModule):
    ...
    def configure(self, *args):
        ...
        self.base.next_input_register = self.start_registers.inputs + 8
    ...
    def read_value(self) -> int:
        ...
        :rtype: int"""
        reg = self.base.read_reg_data(self.start_registers.inputs, length=2)
    ...
    def read_latching_value(self) -> int:
        ...
        :rtype: int"""
        reg = self.base.read_reg_data(self.start_registers.inputs + 2, length=2)
        value = int.from_bytes(reg, byteorder="little")
    ...
    def read_status_word(self) -> StatusWord:
        ...
        :return: status word
        :rtype: StatusWord"""
        reg = self.base.read_reg_data(self.start_registers.inputs + 4)
    ...
    def write_process_data(self, **kwargs) -> None:
        ...
        self.base.write_reg_data(reg_data, self.start_registers.outputs)
    ...
    def read_status(self) -> list[bool]:
        ...
        :rtype: list[bool]"""
        data = self.base.read_reg_data(self.start_registers.inputs + 7)
