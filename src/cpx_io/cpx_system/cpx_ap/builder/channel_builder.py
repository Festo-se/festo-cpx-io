...
class ChannelGroupBuilder:
    """ChannelGroupBuilder for dataclasses"""
...
class ChannelBuilder:
    """ChannelBuilder for dataclasses"""
...
class ChannelListBuilder:
    ...
    def build(self, apdd, direction=None):
        ...
        channel_type_list = [ChannelBuilder().build(d) for d in apdd.get("Channels")]
