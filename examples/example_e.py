...
with CpxE(ip_address="172.16.1.40", modules=modules) as cpxe:
    ...
    # read digital input
    e16di = cpxe.cpxe16di
    one_input = e16di.read_channel(0)  # returns bool
    all_inputs = e16di.read_channels()  # returns list of bool
