...
def test_1module(test_cpxe):
    ...
    assert e16di.start_registers.outputs == 40003
    assert e16di.start_registers.inputs == 45395
    assert test_cpxe.next_output_register == 40003
...
def test_2modules(test_cpxe):
    ...
    assert e8do.start_registers.outputs == 40003
    assert e8do.start_registers.inputs == 45397
...
def test_3modules(test_cpxe):
    ...
    assert e4ai.start_registers.outputs == 40004
    assert e4ai.start_registers.inputs == 45399
    assert test_cpxe.next_output_register == 40004
...
def test_4modules(test_cpxe):
    ...
    assert e4ao.start_registers.outputs == 40004
    assert e4ao.start_registers.inputs == 45404
