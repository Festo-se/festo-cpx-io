...
class TestCpxAp12Di4Do:
    ...
    def test_constructor_correct_type(self):
        ...
        # Assert
        assert isinstance(cpxap12di4do, CpxAp12Di4Do)
    ...
    def test_read_channels_correct_values(self):
        ...
        # Assert
        # first 12 inputs, then 4 outputs, always in lsb nibble
    ...
    def test_read_channel_correct_values_output_numbering_false(self):
        ...
        cpxap12di4do.base = Mock()
        cpxap12di4do.read_channels = Mock(return_value=[True, False] * 8)

        # Act
        channel_values = [cpxap12di4do.read_channel(idx) for idx in range(16)]

        # Assert
        assert channel_values == [True, False] * 8
    ...
    def test_read_channel_correct_values_output_numbering_true(self):
        ...
        cpxap12di4do.base = Mock()
        cpxap12di4do.read_channels = Mock(
            return_value=[
                False,
                False,
                False,
        ...
        # Act
        channel_values = [
            cpxap12di4do.read_channel(idx, output_numbering=True) for idx in range(4)
        ]
    ...
    def test_read_channel_correct_values_output_numbering_true_error(self):
        ...
        cpxap12di4do.base = Mock()
        cpxap12di4do.read_channels = Mock(return_value=[True, False, True, False])

        # Act

        # Assert
        with pytest.raises(IndexError):
            cpxap12di4do.read_channel(4, output_numbering=True)
    ...
    def test_write_channels_correct_values(self):
        ...
        # Assert
        cpxap12di4do.base.write_reg_data.assert_called_with(data, 0)
    ...
    def test_write_channels_too_long(self):
        ...
        with pytest.raises(ValueError):
            cpxap12di4do.write_channels([1, 2, 3, 4, 5])
    ...
    def test_write_channels_too_short(self):
        ...
        # Act and assert
        with pytest.raises(ValueError):
            cpxap12di4do.write_channels([1, 2, 3])
    ...
    def test_clear_channel(self):
        ...
        # Act
        cpxap12di4do.clear_channel(0)

        # Assert
        cpxap12di4do.write_channel.assert_called_with(0, False)
    ...
    def test_set_item(self):
        ...
        # Act
        cpxap12di4do[0] = True
        cpxap12di4do[1] = False
        cpxap12di4do[2] = True
        cpxap12di4do[3] = False

        # Assert
        cpxap12di4do.write_channel.assert_has_calls(
    ...
    def test_configure_debounce_time(self, input_value, expected_value):
        ...
        cpxap12di4do = CpxAp12Di4Do()
        cpxap12di4do.position = MODULE_POSITION
